...
if not anthropic_api_key:
    logger.error("Failed to load Anthropic API key. Make sure it's set in the .env file.")
...
def analyze_with_claude(prompt, text):
    ...
    try:
        ...
        logger.error(traceback.format_exc())
        raise HTTPException(status_code=500, detail="Error in Claude API call")
...
def process_log_file(file_path, prompts):
    ...
    try:
        ...
        for prompt_dict in prompts:
            ...
            result = analyze_with_claude(prompt, log_content)
